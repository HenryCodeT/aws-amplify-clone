...
const switchVariants = cva(
  "peer inline-flex shrink-0 cursor-pointer items-center rounded-full transition-colors duration-short focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-80 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60 data-[state=checked]:bg-primary-80 data-[state=unchecked]:bg-neutral-60 aria-invalid:data-[state=unchecked]:bg-bg-error",
  {
    variants: {
      inputSize: {
        small: "h-4 w-7",
