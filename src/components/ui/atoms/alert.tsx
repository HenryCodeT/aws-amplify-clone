...
const alertVariants = cva(
  "relative w-full rounded-medium py-small px-medium flex items-center gap-medium",
  {
    variants: {
      variant: {
...
>(({ className, ...props }, ref) => (
  <h5
    ref={ref}
    className={cn("mb-xs font-bold text-medium leading-none", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("text-small leading-medium", className)}
    {...props}
  />
));
