...
const badgeVariants = cva(
  "inline-flex items-center gap-xs rounded-small font-medium transition-colors duration-short focus:outline-none focus:ring-2 focus:ring-primary-80 focus:ring-offset-2",
  {
    variants: {
      variant: {
        default: "",
      ...
      style: {
        solid: "",
        outlined: "bg-transparent border-medium",
        subtle: "",
      },
      size: {
        small: "px-xs py-xxs text-xs",
        default: "px-small py-xs text-small",
        large: "px-medium py-small text-medium",
      },
    },
    compoundVariants: [
      // Solid variants
      {
        variant: "default",
        style: "solid",
        class: "bg-neutral-60 text-font-inverse",
      },
      {
        variant: "info",
        style: "solid",
      ...
      >
        ...
        {onRemove && (
          <button
            type="button"
            onClick={onRemove}
            className="ml-xs -mr-xs hover:opacity-70 transition-opacity"
