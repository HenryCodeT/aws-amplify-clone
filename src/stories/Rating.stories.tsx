...
export const CustomMaxValue: Story = {
  render: () => (
    <div className="space-y-medium">
      <div>
        <p className="text-small text-font-secondary mb-xs">Out of 3</p>
        <Rating value={2.5} maxValue={3} showValue />
      </div>
      <div>
        <p className="text-small text-font-secondary mb-xs">Out of 7</p>
        <Rating value={5} maxValue={7} showValue />
      </div>
      <div>
        <p className="text-small text-font-secondary mb-xs">Out of 10</p>
  ...
  render: () => (
    <div className="w-80 space-y-large">
      <div className="border-medium border-border-primary rounded-medium p-medium">
        <h4 className="font-semibold mb-xs">Wireless Headphones</h4>
        <div className="flex items-center gap-xs mb-medium">
          <Rating value={4.5} size="small" />
          <span className="text-small text-font-secondary">(128 reviews)</span>
        </div>
        <p className="text-small text-font-secondary">
      ...
      <div className="border-medium border-border-primary rounded-medium p-medium">
        <h4 className="font-semibold mb-xs">Mechanical Keyboard</h4>
        <div className="flex items-center gap-xs mb-medium">
          <Rating value={4.8} size="small" />
          <span className="text-small text-font-secondary">(342 reviews)</span>
        </div>
        <p className="text-small text-font-secondary">
    ...
    return (
      <div className="w-96 space-y-medium">
        {reviews.map((review, index) => (
          <div
            key={index}
            className="border-b-medium border-border-primary pb-medium last:border-b-0"
          >
            <div className="flex items-center justify-between mb-xs">
              <p className="font-medium text-small">{review.author}</p>
              <Rating value={review.rating} size="small" />
            </div>
            <p className="text-small text-font-secondary">{review.comment}</p>
          </div>
        ))}
      </div>
    );
...
export const RatingSummary: Story = {
  render: () => {
    ...
    return (
      <div className="w-96 border-medium border-border-primary rounded-medium p-large">
        <div className="flex items-center gap-medium mb-large">
          <div className="text-center">
            <div className="text-4xl font-bold">4.5</div>
            <Rating value={4.5} size="small" className="mt-xs" />
            <div className="text-small text-font-secondary mt-xs">
              192 reviews
            </div>
          </div>
        </div>
        ...
        <div className="space-y-small">
          {ratings.map((rating) => (
            <div key={rating.stars} className="flex items-center gap-small">
              <div className="flex items-center gap-xs w-20">
              ...
              <span className="text-small text-font-secondary w-12 text-right">
                {rating.count}
              </span>
            </div>
          ))}
...
export const InteractiveReview: Story = {
  render: () => {
    ...
    if (submitted) {
      return (
        <div className="w-96 border-medium border-border-primary rounded-medium p-large text-center">
          ...
          <h3 className="font-semibold mb-xs">Thank you for your review!</h3>
          <p className="text-small text-font-secondary mb-medium">
            Your {rating}-star rating has been submitted.
          </p>
          <button
            onClick={handleReset}
            className="px-medium py-small bg-neutral-20 hover:bg-neutral-30 rounded-medium text-small transition-colors"
          >
    ...
    return (
      <div className="w-96 border-medium border-border-primary rounded-medium p-large">
        <h3 className="font-semibold mb-small">Rate this product</h3>
        <p className="text-small text-font-secondary mb-medium">
        ...
        <button
          ...
          disabled={rating === 0}
          className={`w-full py-small rounded-medium text-small font-medium transition-colors ${
            rating === 0
...
export const AllSizes: Story = {
  render: () => (
    <div className="space-y-large">
      <div>
        <p className="text-small font-medium mb-small">Small</p>
      ...
      <div>
        <p className="text-small font-medium mb-small">Default</p>
        <div className="space-y-xs">
      ...
      <div>
        <p className="text-small font-medium mb-small">Large</p>
        <div className="space-y-xs">
      ...
      <div>
        <p className="text-small font-medium mb-small">XLarge</p>
        <div className="space-y-xs">
