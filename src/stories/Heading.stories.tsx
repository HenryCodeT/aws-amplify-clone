...
export const LineHeights: Story = {
  render: () => (
    <div className="space-y-xl">
      <div>
        <p className="text-small text-font-secondary mb-xs">Small (1.25)</p>
      ...
      <div>
        <p className="text-small text-font-secondary mb-xs">Medium (1.5)</p>
      ...
      <div>
        <p className="text-small text-font-secondary mb-xs">Large (2)</p>
