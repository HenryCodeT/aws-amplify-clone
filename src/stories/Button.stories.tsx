...
export const AllVariants: Story = {
  render: () => (
    <div className="space-y-medium">
      <div className="flex gap-medium flex-wrap items-center">
...
export const MenuItems: Story = {
  render: () => (
    <div className="w-64 border border-border-secondary rounded-medium p-xs space-y-xs">
      ...
      <div className="border-t border-border-tertiary my-xs" />
