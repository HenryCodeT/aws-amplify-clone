  ...
  render: () => {
    ...
    return (
      <div className="w-96 space-y-medium">
        <h3 className="text-large font-semibold">Email Preferences</h3>
        <div className="space-y-small">
          {items.map((item) => (
            <div key={item.id} className="flex items-center gap-xs">
              ...
              <label
                htmlFor={item.id}
                className="text-medium cursor-pointer flex-1"
              >
                {item.label}
              </label>
            </div>
...
export const SelectAll: Story = {
  render: () => {
    ...
    return (
      <div className="w-64 space-y-medium">
        <div className="flex items-center gap-xs border-b border-border-secondary pb-small">
          <Checkbox
            id="select-all"
          ...
          <label
            htmlFor="select-all"
            className="text-medium font-semibold cursor-pointer flex-1"
          >
            Select All
          </label>
        </div>
        <div className="space-y-small pl-large">
          {items.map((item) => (
            <div key={item.id} className="flex items-center gap-xs">
              <Checkbox
                id={item.id}
    ...
    <div className="w-96 space-y-large">
      <div className="flex gap-xs">
        ...
        <div className="flex flex-col gap-xxs">
          <label htmlFor="marketing" className="text-medium font-medium cursor-pointer">
      ...
      <div className="flex gap-xs">
        ...
        <div className="flex flex-col gap-xxs">
          <label htmlFor="security" className="text-medium font-medium cursor-pointer">
            Security Alerts
          </label>
          <p className="text-small text-font-secondary">
      ...
      <div className="space-y-medium">
        <div className="flex items-center gap-xs">
          <Checkbox
            ...
            onCheckedChange={(checked) => setChecked(checked === true)}
          />
          <label htmlFor="controlled-checkbox" className="text-medium">
...
export const TodoList: Story = {
  render: () => {
    ...
    return (
      <div className="w-80 space-y-small">
        <h3 className="text-large font-semibold mb-medium">My Tasks</h3>
        {todos.map((todo) => (
          <div key={todo.id} className="flex items-center gap-xs py-xs">
            <Checkbox
              id={todo.id}
            ...
            <label
              htmlFor={todo.id}
              className={cn(
                "text-medium cursor-pointer flex-1",
