...
import {
  NumberField,
  NumberInput,
} from "@/components/ui/inputs/number-field";
  ...
  render: () => {
    ...
    return (
      <div className="w-96 space-y-large">
        ...
        <div className="pt-medium border-t-2 border-border-primary">
          <div className="flex justify-between items-center">
            <p className="text-large font-bold">Total:</p>
            <p className="text-large font-bold">${total.toFixed(2)}</p>
          </div>
        </div>
      </div>
    );
  ...
  render: () => {
    ...
    return (
      <div className="w-96 space-y-xs">
        ...
        <Label htmlFor="custom-number">Quantity</Label>
  ...
  render: () => (
    <div className="w-96 space-y-large">
      <div>
        ...
        <NumberInput size="small" defaultValue={1} min={0} max={10} />
      </div>
      <div>
        <Label className="mb-xs block">Default</Label>
        <NumberInput size="default" defaultValue={1} min={0} max={10} />
      </div>
      <div>
        <Label size="large" className="mb-xs block">
          Large
        </Label>
        <NumberInput size="large" defaultValue={1} min={0} max={10} />
      </div>
    </div>
  ),
};
