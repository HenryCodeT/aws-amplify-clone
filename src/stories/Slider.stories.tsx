...
import { Slider, SliderField } from "@/components/ui/inputs/slider";
      ...
      <div className="w-96 space-y-medium">
        ...
        <div className="pt-medium border-t border-border-secondary space-y-xs">
          ...
          <div className="flex gap-xs">
            <button
              onClick={() => setVolume(0)}
              className="px-small py-xs bg-neutral-20 rounded-sm text-small hover:bg-neutral-30"
            >
              Mute
            </button>
            <button
  ...
  render: () => {
    ...
    return (
      <div className="w-96 space-y-medium">
        ...
        <div className="pt-medium border-t border-border-secondary space-y-xs">
          <p className={`text-medium font-semibold ${getTempColor(temp)}`}>
            {temp}°C
          </p>
          <p className="text-small text-font-secondary">
            {temp < 20 && "Cool"}
  ...
  render: () => {
    ...
    return (
      <div className="w-96 space-y-medium">
        ...
        <div
          className="h-24 rounded-medium transition-all duration-medium border-2 border-border-primary flex items-center justify-center"
          style={{ opacity: brightness / 100 }}
        >
          <p className="text-medium font-medium">Preview</p>
        </div>
      </div>
    );
  },
  ...
  render: () => {
    ...
    return (
      <div className="w-96 space-y-large">
        ...
        <div className="space-y-medium pt-medium border-t border-border-secondary">
          <SliderField
            label="Music"
            value={levels.music}
    ...
    return (
      <div className="w-96 space-y-xs">
        ...
        <div className="flex items-center justify-between">
          <Label htmlFor="custom-slider">Volume</Label>
          <span className="text-small text-font-secondary">
            {value[0]}%
          </span>
        </div>
...
export const SliderSizes: Story = {
  render: () => (
    <div className="w-96 space-y-large">
      ...
      <div>
        <Label className="mb-xs block">Default</Label>
