  ...
  render: () => (
    <div className="flex gap-medium">
      <Card variant="outlined" className="w-64">
        <CardContent className="p-large text-center">
...
export const PaddingSizes: Story = {
  render: () => (
    <div className="space-y-medium w-96">
      <Card padding="none">
        <CardContent className="p-small bg-bg-secondary">
          <p className="text-small">No padding (none)</p>
        </CardContent>
      </Card>
      <Card padding="small">
        <CardContent>
          <p className="text-small">Small padding</p>
        </CardContent>
      </Card>
      <Card padding="default">
        <CardContent>
          <p className="text-small">Default padding</p>
        </CardContent>
      </Card>
      <Card padding="large">
        <CardContent>
          <p className="text-small">Large padding</p>
        </CardContent>
      </Card>
    </div>
  ),
...
export const ProductCard: Story = {
  render: () => (
    <Card variant="outlined" interactive className="w-80">
      <div className="aspect-video bg-neutral-20 rounded-t-medium -m-medium mb-0" />
      <CardHeader className="pt-medium">
        <CardTitle>MacBook Pro 14&quot;</CardTitle>
        <CardDescription>M3 Pro chip, 18GB RAM, 512GB SSD</CardDescription>
      </CardHeader>
      <CardContent>
        <p className="text-large font-bold text-primary-80">$1,999</p>
        <p className="text-small text-font-secondary mt-xs">
    ...
    <Card variant="elevated" className="w-80">
      <CardHeader>
        <div className="flex items-center gap-medium">
          ...
          <div>
            <CardTitle className="text-large">John Doe</CardTitle>
    ...
    <div className="grid grid-cols-3 gap-medium">
      <Card variant="filled">
        <CardContent className="text-center">
          ...
          <p className="text-small text-font-secondary mt-xs">Followers</p>
        </CardContent>
      </Card>
      <Card variant="filled">
        <CardContent className="text-center">
          <p className="text-xxxl font-bold text-primary-80">128</p>
          <p className="text-small text-font-secondary mt-xs">Following</p>
        </CardContent>
      </Card>
      <Card variant="filled">
        <CardContent className="text-center">
          <p className="text-xxxl font-bold text-primary-80">42</p>
          <p className="text-small text-font-secondary mt-xs">Posts</p>
        </CardContent>
      </Card>
    </div>
  ),
    ...
    <Card variant="outlined" className="w-96">
      <CardHeader>
        <div className="flex items-start justify-between">
          <div>
            <CardTitle className="text-large">New Message</CardTitle>
    ...
    <div className="grid grid-cols-3 gap-medium">
      <Card variant="outlined">
        ...
        <CardContent>
          ...
          <p className="text-small text-font-secondary mb-medium">/month</p>
      ...
      <Card variant="elevated" className="border-2 border-primary-80">
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs bg-primary-80 text-font-inverse px-xs py-xxs rounded-small font-medium">
              Popular
            </span>
          </div>
      ...
      <Card variant="outlined">
        ...
        <CardContent>
          ...
          <p className="text-small text-font-secondary mb-medium">pricing</p>
          <ul className="space-y-xs text-small">
