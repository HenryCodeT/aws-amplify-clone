...
export const Sizes: Story = {
  render: () => (
    <div className="space-y-xl w-full">
      ...
      <div>
        <p className="text-small text-font-secondary mb-small">Medium</p>
        <Divider size="medium" />
      </div>
      <div>
...
export const Vertical: Story = {
  render: () => (
    <div className="flex h-32 gap-medium">
    ...
    <div className="w-96 space-y-large">
      <div className="space-y-small">
        ...
        <input
          ...
          className="w-full px-medium py-small border border-border-secondary rounded-medium"
        />
      </div>
      <div className="space-y-small">
      ...
      <button className="w-full py-small px-medium bg-primary-80 text-white rounded-medium">
...
export const SectionDivider: Story = {
  render: () => (
    <div className="space-y-large max-w-2xl">
      <div>
        <h3 className="text-xl font-semibold mb-small">Personal Information</h3>
      ...
      <div>
        <h3 className="text-xl font-semibold mb-small">Security Settings</h3>
        <p className="text-font-secondary">
      ...
      <div>
        <h3 className="text-xl font-semibold mb-small">Notifications</h3>
        <p className="text-font-secondary">
