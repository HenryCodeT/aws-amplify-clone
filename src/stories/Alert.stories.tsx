...
export const WithActionButton: Story = {
  render: () => (
    <Alert variant="info">
      ...
      <button className="shrink-0 px-small py-xs bg-primary-80 text-white rounded-small text-small font-medium hover:bg-primary-90 transition-colors">
        Update
      </button>
    </Alert>
  ),
    ...
    <Alert variant="error">
      ...
      <div>
        ...
        <AlertDescription>
          ...
          <ul className="mt-xs ml-medium list-disc space-y-xxxs">
